        ...
        <div class="page-wrapper">
            ...
            <section class="page-banner banner" style="background-image:url(../assets/images/qrc_background.png);">
                ...
                <div class="page-title">
                    <div class="auto-container">
                        <div class="row clearfix">
                            <div class="col-md-6 col-sm-6 col-xs-12 pull-left"><h1>The Balanz</h1></div>
                            <div class="col-md-6 col-sm-6 col-xs-12 pull-right text-right path"><a href="main">Home</a>&ensp;<span class="fa fa-angle-right"></span>&ensp;<a href="project">Project</a>&ensp;<span class="fa fa-angle-right"></span>&ensp;<a href="#">The Balanz Project</a></div>
                        </div>
                    </div>
                </div>
                <!--Page Title Ends-->
                        ...
                        <section class="single-project col-lg-12">
                            ...
                            <div class="project-data clearfix">
                                ...
                                <div class="right col-md-12 col-sm-12 col-xs-12">
                                    <h3>ชื่อลูกค้า</h3>
                                    <p class="li_span_font_size">: : The Balanz</p>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            ...
                                            <ul>
                                                <li class="li_span_font_size"><span class="fa fa-arrow-circle-right"></span> <strong>The balance ศาลายา-พุทธมลฑลสาย 5</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
                                            </ul>
                                            <style>
                                                .li_span_font_size{
                                                    font-size:14px;
