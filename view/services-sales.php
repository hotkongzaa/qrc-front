...
<html>
    <head>
        <meta charset="utf-8">
        <title>Builder Construction Template | Services</title>
        <!-- Stylesheets -->
        ...
        <div class="page-wrapper">
            ...
            <section class="page-banner banner" style="background-image:url(../assets/images/qrc_background.png);">
                ...
                <div class="page-title">
                    <div class="auto-container">
                        <div class="row clearfix">
                            <div class="col-md-6 col-sm-6 col-xs-12 pull-left"><h1>Services</h1></div>
                            <div class="col-md-6 col-sm-6 col-xs-12 pull-right text-right path"><a href="#">Home</a>&ensp;<span class="fa fa-angle-right"></span>&ensp;<a href="#">Services</a></div>
                        </div>
                    </div>
                </div>
                <!--Page Title Ends-->
                        ...
                        <section class="services clearfix">
                            ...
                            <nav class="service-nav col-md-3 col-sm-4 col-xs-12">
                                <ul class="anim-5-all clearfix">
                                    <li><a href="services">งานด้านบริการ <span class="fa fa-angle-right pull-right"></span></a></li>
                                    <li class="current"><a href="services-sales">งานด้านการขาย <span class="fa fa-angle-right pull-right"></span></a></li>
                                </ul>
                            </nav>

                            <!--Service Posts-->
                            <div class="service-posts clearfix col-md-9 col-sm-8 col-xs-12">

                                <!--Service Post-->
                                <article class="service-post col-md-6 col-sm-6 col-xs-12">
                                    <div class="post-inner anim-5-all">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="description">
                                                <p>>> ขายโครงหลังคาสำเร็จรูป ขายเหล็กเส้นรีดเย็น, เหล็กตัว C, แป และโครงหลังคาสำเร็จรูปตามแบบที่ลูกค้าต้องการ พร้อมอุปกรณ์</p-->
