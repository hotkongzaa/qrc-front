...
<head>
<meta charset="utf-8">
<title>Builder Construction Template | Single Project</title>
<!-- Stylesheets -->
                    ...
                    <div class="project-../assets/images anim-5-all clearfix">
                        ...
                        <div class="tabs-box">
                            ...
                            <div class="tab-buttons clearfix">
                                <a href="#image-one" class="tab-btn active"><img src="../assets/images/resource/single-project-image-3.jpg" alt=""></a>
                                <a href="#image-two" class="tab-btn"><img src="../assets/images/resource/single-project-image-3.jpg" alt=""></a>
                                <a href="#image-three" class="tab-btn"><img src="../assets/images/resource/single-project-image-4.jpg" alt=""></a>
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <figure class="tab" id="image-two">
                                    <div class="image">
                                        <img src="../assets/images/resource/single-project-image-7.jpg" alt="">
                                        <div class="overlay anim-5-all"><div class="link-icon"><a href="../assets/images/resource/single-project-image-7.jpg" data-rel="prettyPhoto" title="Gallery Title" class="fa fa-camera"></a></div></div>
                                    </div>
                                </figure>
                                
                                <figure class="tab" id="image-three">
                                    <div class="image">
                                        <img src="../assets/images/resource/single-project-image-6.jpg" alt="">
                                        <div class="overlay anim-5-all"><div class="link-icon"><a href="../assets/images/resource/single-project-image-6.jpg" data-rel="prettyPhoto" title="Gallery Title" class="fa fa-camera"></a></div></div>
                                    </div>
                                </figure>
                            </div>
                            <!--Tab Content End-->
                        ...
                        <div class="right col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row clearfix">
                            	<div class="col-md-7 col-sm-7 col-xs-12">
									...
									<ul>
										<li class="li_span_font_size"><strong>ภัสสร 25 บางนา</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>ภัสสร 28 หนามแดง</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>ภัสสร 33 เลียบทางด่วนลาดกระบัง</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>ภัสสร 37</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>ภัสสร 40</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>Village 24 คลอง 3</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>Village 27 ฉลองกรุง ลาดกระบัง</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>พฤกษาปุริ 3 ชั้น พัฒนาการ 32</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>Village Lite 2 ชั้น พัฒนาการ 32</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>เนทูร่า แพรกษา</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>ลาวัลเล่ หัวหิน</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
										<li class="li_span_font_size"><strong>เดอะปาล์ม พัฒนาการ 38</strong> - ติดตั้งโครงหลังคาสำเร็จรูป</li>
									</ul>
<style>
.li_span_font_size{
font-size:16px;
